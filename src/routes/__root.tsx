  ...
  head: () => ({
    meta: [
      ...
      { title: "Dias Transporte — Transfer São Luís e Lençóis Maranhenses" },
      {
        name: "description",
        content:
          "Transfer particular entre São Luís, Barreirinhas, Santo Amaro e a Rota das Emoções. Reserve pelo WhatsApp.",
      },
      { name: "author", content: "Dias Transporte" },
      { property: "og:title", content: "Dias Transporte — Do desembarque às dunas" },
      {
        property: "og:description",
        content: "Transfers particulares no Maranhão com carros climatizados e motorista da casa.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "Dias Transporte" },
