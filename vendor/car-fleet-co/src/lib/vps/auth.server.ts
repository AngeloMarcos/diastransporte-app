...
// HttpOnly com token opaco. Mesmo padrão do projeto irmão Dias Transporte.
// Server-only.
...
export const COOKIE_SESSAO = "carfleet_sessao";
...
/**
 * Cria um usuário de login (admin ou motorista) — só é chamada a partir do
 * servidor por uma operação já autorizada (criar admin via script, ou o
 * admin logado criando um motorista), nunca por um formulário público de
 * cadastro: este app não tem self-signup.
 */
